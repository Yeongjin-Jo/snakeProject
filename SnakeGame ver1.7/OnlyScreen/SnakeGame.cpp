...
void SnakeGame::initialize1()
{
	...
	maxLength = 30;
	gateScore = 0;
	trGrowthScore = 300; trPoisonScore = 100; trGateScore = 100, trLength = 5;
...
void SnakeGame::initialize2()
{
	std::deque<SnakePiece> empty;
	std::swap(snake.prev_pieces, empty);
	trGrowthScore = 500; trPoisonScore = 300; trGateScore = 300, trLength = 5;
	apple = NULL;
	poison = NULL;
	gate1 = NULL;
	gate2 = NULL;
...
void SnakeGame::initialize3()
{
	std::deque<SnakePiece> empty;
	std::swap(snake.prev_pieces, empty);
	trGrowthScore = 1000; trPoisonScore = 500; trGateScore = 500, trLength = 8;
	apple = NULL;
	poison = NULL;
	gate1 = NULL;
	gate2 = NULL;
